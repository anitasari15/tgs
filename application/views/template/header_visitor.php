...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="<?php echo site_url() ?>visitor/dashboard">KEJAM</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url() ?>visitor/dashboard">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url() ?>artikel/index">Artikel</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url() ?>visitor/register">Register</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url() ?>visitor/login">Login</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <header class="jumbotron my-4">
        <h1 class="display-3">SELAMAT DATANG DI KEJAM (KOPERASI PEMINJAMAN)</h1>
